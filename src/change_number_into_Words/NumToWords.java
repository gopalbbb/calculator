...
public class NumToWords {
    ...
    public String convert(int number) {
        ...
        int word;
        string = "";
       //use switch case //user-defined method that converts a number to words
        while (number != 0) {
            switch (n) {
                case 1:
                    word = number % 100;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The given number"+" "+num+" "+" is in words="+" "+ inwords);
    }
}